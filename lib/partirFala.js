...
/**
 * O primeiro pode ser menor que os outros — mas NAO pode ser um toco.
 *
 * A TROCA QUE FOI DESFEITA — 18/09/2026, fim do dia
 * Este piso ja foi 8, para o Zeus abrir a boca o mais rapido possivel. Ficou
 * escrito aqui, na hora, que a conta disso era uma pausa no meio da resposta, e
 * que se soasse picotado bastava subir o numero.
 *
 * Soou. O Paulo: *"ele responde a frase, ai passa uns quatro, cinco segundos
 * para continuar o raciocinio."*
 *
 * O que acontecia: ele abria com "Sim." ou "Certo." — tres letras, meio segundo
 * de audio — e o pedaco seguinte era grande demais para a maquina preparar
 * nesse meio segundo. Sobrava o buraco.
 *
 * Com o piso em 35, a abertura nunca sai sozinha: ela vai junto com o comeco da
 * explicacao. A primeira palavra demora um pouco mais, e a resposta sai
 * inteira, sem tropeco.
 *
 * ESTA E A LICAO, e vale para a proxima vez: comecar meio segundo mais cedo nao
 * paga um buraco de quatro segundos no meio. Quem ouve nao cronometra o comeco
 * — quem ouve percebe a pausa.
 */
export const MINIMO_PRIMEIRO = 35

/** Alvo do primeiro pedaco. Acima do piso, e o menor que der. */
