...
export const NUNCA_SOZINHO = [
  ...
  // O PROPRIO ZEUS — a porta que nao pode ser trancada por dentro.
  //
  // Nenhum robo mexe na trava que o segura, no proprio codigo, no servico da
  // VPS ou na chave. Sem esta linha, bastaria uma decisao infeliz no turno
  // aberto para ele se fechar e ninguem mais entrar para consertar.
  //
  // Vale sempre: o Paulo precisa poder mexer nele a qualquer hora, e o Zeus
  // nunca pode ser quem decide se isso e permitido.
  'o_proprio_zeus',
]
